...
plot_2 <-ggplot(NULL)+
  ...
  geom_jitter(data = fitted_points_2, aes(x = teacher_number_of_previously_posted_projects, y = project_is_approved),height = 0.01) +
...
ggplot() +
  # Training data with black points:
  geom_jitter(data = fitted_points_logistic_3, aes(x = project_grade_category, y = fitted_prob), height = 0.01) + labs(x = "Project Grade Category", y = "Fitted Probability")+
